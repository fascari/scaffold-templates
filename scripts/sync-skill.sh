...
# version in github.com/fascari/scaffold-templates.
#
# Behavior:
...
#
# Usage:
#   bash <(curl -fsSL https://raw.githubusercontent.com/fascari/scaffold-templates/main/scripts/sync-skill.sh)
...
UPSTREAM_RAW="https://raw.githubusercontent.com/fascari/scaffold-templates/main/skills/scaffolding-project/SKILL.md"

if [ ! -e "$SKILL_LINK" ]; then
  log "scaffolding-project skill is not installed at $SKILL_LINK"
  log "run: bash <(curl -fsSL https://raw.githubusercontent.com/fascari/scaffold-templates/main/scripts/install.sh)"
  exit 0
fi
