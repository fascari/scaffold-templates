...
This skill captures the workflow for evolving `fascari/scaffold-templates`. Use it when **changing the templates** (not when *using* them — that's `scaffolding-project`).
